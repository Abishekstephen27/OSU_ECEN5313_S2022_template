...
C {sky130_fd_pr/pfet_g5v0d10v5.sym} 130 -260 3 0 {name=M2
L=0.5
W=20
nf=1
mult=1580
...
device=resistor
m=1}
C {devices/vsource.sym} 30 -60 0 0 {name=V1 value=3.6}
...
device=resistor
m=1}
C {devices/vsource.sym} 130 -170 0 0 {name=V2 value="pulse(0 3.6 0 0.01u 0.01u 0.488u 1u)"}
C {devices/code.sym} -160 -330 0 0 {name=MODELS
only_toplevel=true
...
C {devices/code_shown.sym} -480 -210 0 0 {name=Power Calculation
only_toplevel=true
place=end
value="
.tran 1u 200u
.save all
 ...
 .control
        run
        meas tran idd_ave INTEG i(VIin) from=190u to=191u
 ...
 .endc
"}
C {devices/lab_pin.sym} 130 -220 0 0 {name=l4 sig_type=std_logic lab=Vcontrol}
C {devices/lab_pin.sym} 290 -280 1 0 {name=l5 sig_type=std_logic lab=Vmid}
C {devices/ammeter.sym} 30 -180 2 0 {name=VIin}
